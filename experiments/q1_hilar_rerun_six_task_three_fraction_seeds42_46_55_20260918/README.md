...
Each unit trains a fresh HILA/DeepSets adapter for 100 epochs, selects by validation Macro AUROC, caches exactly paired frozen train/validation features, and trains a fresh no-anchor HiLAR residual classifier. Formal test is globally gated until every train/validation unit succeeds, and each test unit is evaluated once.
