...
case "${FRACTION_KEY}" in 100pct) FRACTION=1.0 ;; 10pct) FRACTION=0.10 ;; 1pct) FRACTION=0.01 ;; *) exit 2 ;; esac
...
assert h == "15e456964c5f819aa882522a203946b515cc1034e217dfcbc474e5e50bf1719a", h
PY
