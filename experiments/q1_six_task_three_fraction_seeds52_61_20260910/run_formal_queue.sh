...
CAMPAIGN=q1-six-task-three-fraction-seeds52-61-20260910; CODE="${ROOT}/src/CLEAR-HUG/experiments/q1_six_task_three_fraction_seeds52_61_20260910"; OUT="${ROOT}/results/${CAMPAIGN}"; STATUS="${OUT}/${NODE}-formal-queue-status.json"; LOG="${OUT}/${NODE}-formal-queue.log"
exec > >(tee -a "${LOG}") 2>&1
