...
def main():
    ...
    parser.add_argument('--train-records',type=int,default=1654)
    ...
    for seed in seeds:
        ...
        assert payload['train_fraction']==args.train_fraction and payload['train_records']==args.train_records
    ...
    result={'schema_version':1,'status':'passed','task':'csn','seeds':list(seeds),
      'train_fraction':args.train_fraction,'train_val_units':3,'model_checkpoints':9,
